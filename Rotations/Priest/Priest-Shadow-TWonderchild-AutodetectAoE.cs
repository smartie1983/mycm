...
namespace CloudMagic.Rotation
{
    public class TWonderchildSP2 : CombatRoutine
    {
        ...
        public override void Initialize()
        {
            ...
            Log.WriteCloudMagic("Welcome to TWonderchild's Shadow Priest", Color.Black);
            Log.DrawHorizontalLine();
            Log.WriteCloudMagic("Please use the following Talents: 1211111", Color.Black);
            Log.WriteCloudMagic("Surrender to Madness is not supported.", Color.Black);
            Log.WriteCloudMagic("Check the ToDo-List before reporting bugs/requesting features", Color.Black);
            Log.WriteCloudMagic("Cooldown Hotkey: F7", Color.Black);
