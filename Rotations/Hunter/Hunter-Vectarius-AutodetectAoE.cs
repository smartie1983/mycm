...
//dire_frenzy,if=(pet.cat.buff.dire_frenzy.remains<=gcd.max*1.2)|(charges_fractional>=1.8)|target.time_to_die<9
					...
					((WoW.PetBuffTimeRemaining("Dire Frenzy") <= (GCD*1.8)) 
					|| (WoW.PlayerSpellCharges("Dire Frenzy") >=2) 
					|| (WoW.SpellCooldownTimeRemaining("Dire Frenzy") <= 1020 && WoW.PlayerSpellCharges("Dire Frenzy") >=1)))
                    {
...
//dire_frenzy,if=(pet.cat.buff.dire_frenzy.remains<=gcd.max*1.2)|(charges_fractional>=1.8)|target.time_to_die<9
					if (WoW.CanCast("Dire Frenzy") && !WoW.IsSpellOnCooldown("Dire Frenzy")&& WoW.IsSpellInRange("Cobra Shot") && WoW.PetHasBuff("Beast Cleave") && WoW.PetBuffTimeRemaining("Beast Cleave") > GCD &&
						((WoW.PetBuffTimeRemaining("Dire Frenzy") <= (GCD*1.8)) 
						|| (WoW.PlayerSpellCharges("Dire Frenzy") >=2) 
						|| (WoW.SpellCooldownTimeRemaining("Dire Frenzy") <= 1020 && WoW.PlayerSpellCharges("Dire Frenzy") >=1)))
                    {
...
// - Survival Hunter	
		...
		{		
            ...
            {
Log.Write("CDRemain Bite" + WoW.SpellCooldownTimeRemaining("Mongoose Bite") , Color.Red);		
